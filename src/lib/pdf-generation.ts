...
const createPdfHtml = (
  ...
  return `
    <div style="font-family: Arial, sans-serif; color: #333; margin: 20px; border: 1px solid #eee; box-shadow: 0 0 10px rgba(0,0,0,0.1); font-size: 12px;">
      ...
      <div style="padding: 0 20px 20px 20px; text-align: center; border-top: 1px solid #eee; margin-top: 20px;">
        <p style="font-style: italic; font-size: 11px; color: #555;">"${quote}"</p>
      </div>
...
export const generateInvigilatorPdf = async (
  ...
  try {
    ...
    const htmlContent = createPdfHtml(invigilator, duties, collegeName, examTitle, quote);
