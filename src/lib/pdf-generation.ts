  ...
  return `
    <div style="font-family: Arial, sans-serif; color: #333; margin: 20px; border: 1px solid #eee; box-shadow: 0 0 10px rgba(0,0,0,0.1); font-size: 12px;">
      <div style="padding: 15px; text-align: center; border-bottom: 1px solid #eee;">
        <h1 style="margin: 0; font-size: 20px; color: #333;">${collegeName || 'College Name'}</h1>
        <p style="margin: 3px 0 0; font-size: 16px; color: #555;">${examTitle || 'Examination Name'}</p>
        <p style="margin: 3px 0 0; font-size: 14px; font-weight: bold; color: #333;">Invigilator's Duty Summary</p>
      </div>
